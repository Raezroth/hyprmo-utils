...
# Copyright 2024 Hypmo Contributors
...
finish_blinking() {
	hyprmo_wakelock.sh unlock hyprmo_playing_with_leds
...
blink_leds() {
	...
	hyprmo_wakelock.sh lock hyprmo_playing_with_leds 2s
...
[ -z "$HYPRMO_DISABLE_LEDS" ] || exit 1

exec 3<> "${XDG_RUNTIME_DIR:-$HOME}/hyprmo.led.lock"
